...
- Fix Engineering, science, and comms widgets not having their custom positions persist between screen refreshes
- Rename the "Terran" origin to "TSN", to avoid confusion with mostly-terran-pirates

Console selection screen:
- Allow selecting multiple consoles at once (Artemis 2 parity) (vanilla issue [#475](https://github.com/artemis-sbs/LegendaryMissions/issues/475))
  - Can switch between consoles using tabs along the top of the screen
- Prevent multiple clients from selecting the same console (Artemis 2 parity) (vanilla issue [#35](https://github.com/artemis-sbs/LegendaryMissions/issues/35))
...
- Allow configuring player ship names and ship classes (Artemis 2 parity)
