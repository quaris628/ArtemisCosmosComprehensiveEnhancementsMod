...
"Do I need to install this mod for clients, or just the server?" - You must install on all the clients and the server.
...
- Display per-player-ship statistics
  - Ship name and type
  - Whether the ship survived or was destroyed
...
Mission | Is it ok to run this mission with this mod installed? | Does the Comprehensive Enhancements Mod work? | Comments
--- | --- | --- | ---
...
--- | --- | --- | --- | ---
[Unofficial Patch](https://github.com/quaris628/ArtemisCosmosUnofficialPatch) v1.6 | Yes, but there's no reason to | Unofficial Patch first, Comprehensive Enhancements Mod second | Yes | The Comprehensive Enhancements Mod already includes the Unofficial Patch
...
[Eastern Front Mod](https://github.com/quaris628/ArtemisCosmosEasternFrontMod) any version | Yes, but there's no reason to | Comprehensive Enhancements Mod first, Eastern Front Mod second | Yes | The Eastern Front Mod already includes the Comprehensive Enhancements Mod
