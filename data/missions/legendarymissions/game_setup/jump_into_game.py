...
def jump_into_game(delay_reroute_workaround=False):
    ...
    first_console = GAME_SETUP_DATA.get_all_console_slots_selected_by_client(client_id)[0]
    
    gui_switch_to(first_console.label, delay_reroute_workaround=delay_reroute_workaround)
