...
def create_repair_levels_display(ship_id):
    ...
    gui_text("System", style=f"font:gui-1;justify:left;padding:3px,0;color:{color_text_secondary()};")
    gui_text("Condition", style=f"font:gui-1;col-width:75px;justify:right;padding:0,0,3px,0;color:{color_text_secondary()};")
    gui_row(f"row-height:2px;background:{color_divider()};")
    gui_blank()
    ...
    for system in all_systems_on_ship:
        ...
        gui_text(system.get_display_string(), style=f"font:gui-1;justify:left;padding:3px,0;color:{color_text()};")
        ...
        gui_row(f"row-height:2px;background:{color_divider_secondary()};")
        gui_blank()
...
_HEAT_POOL_SYSTEMS = {
    ...
    HeatPool.ENGINES: [System.MANEUVER, System.IMPULSE, System.WARP, System.JUMP],
...
_REPAIR_DISPLAY_BACKGROUND_COLOR = color_background_secondary_opaque()
