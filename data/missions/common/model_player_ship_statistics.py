...
class PlayerShipStatistics(GameAndPlayersStatistics):
    ...
    def record_self_destroyed(self, player_ship_id):
        self._was_destroyed = True
        self._remaining_energy = None
        self._remaining_ordinance_by_type = None
        self._could_loot = can_loot(player_ship_id)
        self._deaths_count += 1
    
    @property
    def deaths_count(self):
        return self._deaths_count
