...
from sbs_utils.procedural.gui import gui_section, gui_text, gui_checkbox, gui_hide, gui_represent, gui_show, gui_message
...
def _sync_console_checkbox_on_ship_selection_changed():
    ...
    for console_slot in SHIP.get_all_console_slots():
        checkbox, primary_label, taken_text = _get_console_checkbox_gui_elements(console_slot.identifier) # pylint: disable=unused-variable
        if checkbox is None:
            continue
